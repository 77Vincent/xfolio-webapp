    ...
    return (
      <div className="teacher-control-panel" style={wrapStyle}>
        <div className="menus-wrap">
          ...
          <NavLink to="/dashboard/plan/t" className="menu-item" activeClassName="current">课程安排(学生)</NavLink>
          <NavLink to="/dashboard/plan/s" className="menu-item" activeClassName="current">课程安排(老师)</NavLink>
